...
export class MysteryBox extends ethereum.SmartContract {
  static bind(address: Address): MysteryBox {
    return new MysteryBox("MysteryBox", address);
  }
  ...
  getWhitelistRoot(): Bytes {
    let result = super.call(
      "getWhitelistRoot",
      "getWhitelistRoot():(bytes32)",
      []
    );
  ...
  try_getWhitelistRoot(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "getWhitelistRoot",
      "getWhitelistRoot():(bytes32)",
      []
...
export class PrivateMintCall extends ethereum.Call {
  get inputs(): PrivateMintCall__Inputs {
    return new PrivateMintCall__Inputs(this);
  }

  get outputs(): PrivateMintCall__Outputs {
    return new PrivateMintCall__Outputs(this);
  }
}

export class PrivateMintCall__Inputs {
  _call: PrivateMintCall;

  constructor(call: PrivateMintCall) {
    this._call = call;
  }
...
export class PrivateMintCall__Outputs {
  _call: PrivateMintCall;
...
export class SetPublicMintCall extends ethereum.Call {
  get inputs(): SetPublicMintCall__Inputs {
    return new SetPublicMintCall__Inputs(this);
  }

  get outputs(): SetPublicMintCall__Outputs {
    return new SetPublicMintCall__Outputs(this);
  }
}

export class SetPublicMintCall__Inputs {
  _call: SetPublicMintCall;

  constructor(call: SetPublicMintCall) {
    this._call = call;
  }

  get publicMintEnabled(): boolean {
    return this._call.inputValues[0].value.toBoolean();
  }
}

export class SetPublicMintCall__Outputs {
  _call: SetPublicMintCall;
...
export class SetWhitelistRootCall extends ethereum.Call {
  get inputs(): SetWhitelistRootCall__Inputs {
    return new SetWhitelistRootCall__Inputs(this);
  }

  get outputs(): SetWhitelistRootCall__Outputs {
    return new SetWhitelistRootCall__Outputs(this);
  }
}

export class SetWhitelistRootCall__Inputs {
  _call: SetWhitelistRootCall;

  constructor(call: SetWhitelistRootCall) {
    this._call = call;
  }
...
export class SetWhitelistRootCall__Outputs {
  _call: SetWhitelistRootCall;

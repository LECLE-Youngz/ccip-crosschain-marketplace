...
export class ExclusiveNFT__checkUpkeepResult {
  value0: boolean;
  value1: Bytes;
...
export class ExclusiveNFT extends ethereum.SmartContract {
  static bind(address: Address): ExclusiveNFT {
    return new ExclusiveNFT("ExclusiveNFT", address);
  }
  ...
  checkUpkeep(param0: Bytes): ExclusiveNFT__checkUpkeepResult {
    let result = super.call("checkUpkeep", "checkUpkeep(bytes):(bool,bytes)", [
      ethereum.Value.fromBytes(param0)
    ]);

    return new ExclusiveNFT__checkUpkeepResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_checkUpkeep(
    param0: Bytes
  ): ethereum.CallResult<ExclusiveNFT__checkUpkeepResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ExclusiveNFT__checkUpkeepResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
  ...
  keys(param0: BigInt): BigInt {
    let result = super.call("keys", "keys(uint256):(uint256)", [
  ...
  try_keys(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("keys", "keys(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  s_isSold(param0: BigInt): boolean {
    let result = super.call("s_isSold", "s_isSold(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_s_isSold(param0: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("s_isSold", "s_isSold(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  unrevealURI(): string {
    let result = super.call("unrevealURI", "unrevealURI():(string)", []);

    return result[0].toString();
  }

  try_unrevealURI(): ethereum.CallResult<string> {
    let result = super.tryCall("unrevealURI", "unrevealURI():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;

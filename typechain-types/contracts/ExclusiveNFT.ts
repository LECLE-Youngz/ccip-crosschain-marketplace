...
export interface ExclusiveNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_nextTokenId"
      | "approve"
...
export interface ExclusiveNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ExclusiveNFT;
  ...
  keys: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  s_isSold: TypedContractMethod<[arg0: BigNumberish], [boolean], "view">;

  safeMint: TypedContractMethod<
    [_to: AddressLike, _revealURI: string],
    [void],
    "nonpayable"
  >;
  ...
  unrevealURI: TypedContractMethod<[], [string], "view">;
